...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Zcashdarklite " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"s1.zcashdarklite.xyz", "208.115.99.226"},
    {"s2.zcashdarklite.xyz", "168.194.167.47"},
    {"s3.zcashdarklite.xyz", "80.241.210.114"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Zcashdarklite is probably already running."), addrBind.ToString().c_str());
        else
